<template>
    <section>
        <img src="/public/images/Logo7Gates-gold.svg" alt="logo 7gg" height="150">
        <h1>Выберите язык</h1>
        <ul>
            <li v-for="lang in langs">
               <router-link :to="{name: 'city'}" ><button>{{ lang }}</button></router-link>
            </li>
        </ul>
    </section>
<!--    <section>-->
...
const langs = ref(['Русский', 'English', 'Chinese'])
